<!-- Footer for Author Connections -->
<template>
  <div class="absolute inset-x-0 bottom-0 h-12 bg-gray-100">
    <div class="relative flex items-top justify-center max-h-16  sm:items-center sm:pt-0">
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center pt-3 space-x-2">
          <a href="https://github.com/HLMelton" target="_blank"><svg
